<%@ Page Title="" Language="C#" MasterPageFile="~/Administrador/Administrador.Master" AutoEventWireup="true" CodeBehind="Eliminar.aspx.cs" Inherits="ProyectoIPC2.Eliminar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td></td>
            <td>
                <asp:Button ID="Button1" runat="server" Text="Eliminar" class="btn btn-theme btn-block" OnClick="Button1_Click" ValidationGroup="registro" CausesValidation="true" />
            </td>
            <td></td>
        </tr>
    </table>
